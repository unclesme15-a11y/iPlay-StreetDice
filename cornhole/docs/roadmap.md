...
- Approve the rules contract (`game-rules.md`) and settle `open-decisions.md`.
...
- Cornhole rules engine: innings, alternating throws, cancellation scoring, win at 21, house-rule toggles.
...
- HUD, bag counters, inning summary.
